...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        if (listPreference != null) {
            ...
            listPreference.setDialogTitle(Utilities.getBanglaSpannableString(getString(R.string.sync_options), this));
        }
    ...
    private void setBanglaTextToView() {
        categoryLocation.setTitle(getString(R.string.sync_title));
        categoryAboutUs.setTitle(Utilities.getBanglaSpannableString(getString(R.string.title_about_us), this));
        preferenceLocation.setTitle(Utilities.getBanglaSpannableString(getString(R.string.sync_options), this));
